...
public class APITesting027_RestAssured_TestNG_AssertJ_Assertions {
    ...
    public void test_POST() {
        ...
        validatableResponse.body("booking.firstname", Matchers.equalTo("Manisha"));
        validatableResponse.body("booking.lastname", Matchers.equalTo("Shinde"));
        ...
        Assert.assertEquals(firstname, "Manisha");
        Assert.assertEquals(lastname, "Som");
        Assert.assertNotNull(bookingId);


        // AssertJ( 3rd- Lib to Assertions) - 20%
        assertThat(bookingId).isNotNull().isPositive().isNotZero();
        assertThat(firstname).isNotEmpty().isNotBlank().isNotNull().isEqualTo("Manisha");
